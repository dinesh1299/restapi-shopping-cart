...
urlpatterns = [
    ...
    path('throttle_rating_list',ThrottleRatingList.as_view(),name='t-rating-list'),
    path('paging_rating_list',PageRatingList.as_view(),name='p-rating-list'),  
    path('throttle_rating_deatil',ThrottleRatingDetail.as_view(),name='t-rating-detail'),
